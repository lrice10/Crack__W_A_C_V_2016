    ...
    \subsection{Evaluation metric}
        ...
        \begin{table}
            ...
            \begin{center}
                ...
                \caption{Results comparison \comment{I don't understand the table in the shared google doc, can someone explain or put some numbers in here (it would be helpful). Are we comparing to other methods?}}
                \label{tab:Results}
